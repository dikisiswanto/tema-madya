const paths = {
    ...
    'bell-ring': '<path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"/><path d="M10 21h4M4 4l-2-2M20 4l2-2"/>',
    'book-open': '<path d="M3 5.5A2.5 2.5 0 0 1 5.5 3H11v17H5.5A2.5 2.5 0 0 0 3 22z"/><path d="M21 5.5A2.5 2.5 0 0 0 18.5 3H13v17h5.5A2.5 2.5 0 0 1 21 22z"/>',
    'calendar-days': '<rect x="3" y="4" width="18" height="17" rx="2"/><path d="M16 2v4M8 2v4M3 9h18"/><path d="M8 13h2M14 13h2M8 17h2M14 17h2"/>',
    'chevron-down': '<path d="m6 9 6 6 6-6"/>',
    'chevron-left': '<path d="m15 18-6-6 6-6"/>',
    'chevron-right': '<path d="m9 18 6-6-6-6"/>',
    'circle-help': '<circle cx="12" cy="12" r="9"/><path d="M9.6 9a2.5 2.5 0 1 1 4.2 1.8c-.9.7-1.8 1.1-1.8 2.7"/><path d="M12 17h.01"/>',
    ...
    'graduation-cap': '<path d="m3 10 9-5 9 5-9 5z"/><path d="M7 12.5V17c3 2 7 2 10 0v-4.5"/><path d="M21 10v6"/>',
    ...
    'palette': '<path d="M12 3a9 9 0 1 0 0 18h1.2a2 2 0 0 0 0-4H12a2 2 0 0 1 0-4h2a7 7 0 0 0 0-10Z"/><circle cx="7.5" cy="10" r=".7"/><circle cx="9" cy="6.8" r=".7"/><circle cx="13" cy="6" r=".7"/>',
    ...
    'running': '<circle cx="13" cy="5" r="2"/><path d="m9 9 3 2 2-2 3 2M12 11l-2 5-3 3M12 11l4 5 3 1"/>',
    'globe': '<circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18"/>',
    'hand-heart': '<path d="M6 11a4 4 0 0 1 6-3 4 4 0 0 1 6 3c0 4-6 7-6 7s-6-3-6-7Z"/><path d="M3 13v5a2 2 0 0 0 2 2h6"/>',
    'laptop-code': '<rect x="3" y="4" width="18" height="13" rx="2"/><path d="M2 20h20M9 9l-2 2 2 2M15 9l2 2-2 2"/>',
    'microchip': '<rect x="7" y="7" width="10" height="10" rx="1"/><path d="M9 2v3M15 2v3M9 19v3M15 19v3M2 9h3M2 15h3M19 9h3M19 15h3"/>',
    'futbol': '<circle cx="12" cy="12" r="9"/><path d="m12 7 3 2-1 4h-4l-1-4zM9 13l-3 2M15 13l3 2M10 9 8 6M14 9l2-3M10 17l2-2 2 2"/>',
    'paint-brush': '<path d="m14 4 6 6-9 9-6-6z"/><path d="M5 13 3 15l2 2-2 2h5l2-2M14 4l2-2 2 2-2 2"/>',
    ...
    'quote-left': '<path d="M7 11H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3v6ZM16 11h-3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3v6Z"/>',
    'user-graduate': '<path d="m3 9 9-5 9 5-9 5zM7 11v4c3 2 7 2 10 0v-4M12 14v6M8 20h8"/>',
    'chalkboard-teacher': '<rect x="3" y="4" width="13" height="12" rx="1"/><path d="M7 20h5M9 16v4M18 8a3 3 0 1 0 0 6M18 14v5M16 19h5"/>',
    ...
    'brand-instagram': '<rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/>',
    'brand-youtube': '<path d="M21.6 7.2a2.7 2.7 0 0 0-1.9-1.9C18 4.8 12 4.8 12 4.8s-6 0-7.7.5a2.7 2.7 0 0 0-1.9 1.9A28.5 28.5 0 0 0 2 12a28.5 28.5 0 0 0 .4 4.8 2.7 2.7 0 0 0 1.9 1.9c1.7.5 7.7.5 7.7.5s6 0 7.7-.5a2.7 2.7 0 0 0 1.9-1.9A28.5 28.5 0 0 0 22 12a28.5 28.5 0 0 0-.4-4.8Z"/><path d="m10 15.3 5-3.3-5-3.3z" fill="currentColor" stroke="none"/>',
    ...
    'folder-open': '<path d="M3 7a2 2 0 0 1 2-2h5l2 2h7a2 2 0 0 1 2 2v1H3z"/><path d="m3 10 2 9h13l3-10H3z"/>',
    'shield-check': '<path d="M12 3 20 6v5c0 5-3.2 8.5-8 10-4.8-1.5-8-5-8-10V6z"/><path d="m8.5 12 2.2 2.2 4.8-5"/>',
    'school': '<path d="m3 9 9-5 9 5-9 5z"/><path d="M7 11v5c3 2 7 2 10 0v-5"/><path d="M21 9v6"/>',
    'newspaper': '<path d="M4 5h15v14H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z"/><path d="M7 9h8M7 13h8M7 17h5"/><path d="M19 8h3v9a2 2 0 0 1-2 2h-1"/>',
    'external-link': '<path d="M14 5h5v5M19 5l-8 8"/><path d="M18 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5"/>',
...
function normalizeFontAwesomeName(name) {
    const value = String(name || '').replace(/[^a-zA-Z0-9_ -]/g, '').trim();
...
export function iconMarkup(name, className = '', color = '') {
    if (isFontAwesomeIcon(name)) return fontAwesomeMarkup(name, className, color);
    const key = aliases[name] || name || 'sparkles';
    if (!paths[key] && /^[a-z0-9-]+$/i.test(String(name || ''))) return fontAwesomeMarkup(`fas fa-${name}`, className, color);
...
export function initIcons(root = document) {
    ...
    hosts.forEach((host) => {
        ...
        svg.setAttribute('class', `icon icon-tabler ${host.className || ''}`.trim());
        const name = host.getAttribute('data-lucide') || 'sparkles';
        const key = aliases[name] || name;
        if (!paths[key] && /^[a-z0-9-]+$/i.test(name)) {
            const fallback = document.createElement('i');
            fallback.setAttribute('aria-hidden', 'true');
            fallback.setAttribute('class', `fas fa-${name} ${host.className || ''}`.trim());
