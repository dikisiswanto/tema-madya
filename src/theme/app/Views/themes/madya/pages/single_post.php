...
<?= $this->include('themes/madya/components/page-header', ['eyebrow' => 'Berita sekolah', 'title' => $article['title'] ?? 'Artikel', 'description' => '', 'breadcrumbs' => [['url' => base_url('news'), 'label' => 'Berita'], ['label' => $article['title'] ?? 'Artikel']]]) ?>
