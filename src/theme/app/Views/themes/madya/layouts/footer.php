<footer class="site-footer" role="contentinfo">
    ...
    <div class="footer-main">
        <div class="theme-container madya-footer-grid footer-grid-rich">
            <div class="footer-intro">
                <a class="madya-footer-brand" href="<?= base_url() ?>" aria-label="Beranda <?= esc($site_name ?? 'SekolahKu') ?>">
                    <span class="brand-mark footer-brand-mark" aria-hidden="true"><?= view('themes/madya/components/ui/icon', ['name' => $site_logo_icon ?? 'graduation-cap', 'class' => 'brand-icon']) ?></span>
