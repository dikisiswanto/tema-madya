...
<title><?= esc($themeTitle) ?></title>
    ...
    <?php if ($themeOgImage): ?><meta property="og:image" content="<?= esc($themeOgImage) ?>"><?php endif; ?>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Instrument+Sans:wdth,wght@75..100,400..700&family=Newsreader:opsz,wght@6..72,400..700&display=swap">
