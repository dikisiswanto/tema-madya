...
?>
<header class="page-hero<?= $bannerImage ? ' page-hero-has-image' : '' ?><?= $variant !== '' ? ' page-hero-' . esc($variant) : '' ?>"<?php if ($bannerImage): ?> style="--page-hero-image: url('<?= esc($bannerImage) ?>')"<?php endif; ?>>
