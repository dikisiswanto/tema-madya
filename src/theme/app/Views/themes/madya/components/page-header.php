...
<?php endif; ?>>
    ...
    <div class="theme-container page-hero-inner">
        <?php if ($breadcrumbs): ?><nav class="breadcrumb" aria-label="Jejak navigasi"><a href="<?= base_url() ?>">Beranda</a><?php foreach ($breadcrumbs as $crumb): ?><span aria-hidden="true">/</span><?php if (!empty($crumb['url'])): ?>
