...
test('homepage and hybrid navigation are present', async ({ page }) => {
    ...
    const programsLink = page.locator('a[href="/#programs"]:visible').first();
...
test('desktop navigation activates at the Tailwind lg breakpoint', async ({
    page,
}) => {
    // Tailwind's default lg breakpoint is 64rem = 1024px.
